...
const AppSelectValue = SelectPrimitive.Value;
...
AppSelectScrollUpButton.displayName =
...
AppSelectScrollDownButton.displayName =
  SelectPrimitive.ScrollDownButton.displayName;

const AppSelectContent = React.forwardRef<
...
const AppSelectLabel = React.forwardRef<
...
const AppSelectItem = React.forwardRef<
