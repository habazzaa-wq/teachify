...
export const SectionHeader = memo(function SectionHeader({
  ...
  return (
    <div className={cn("flex items-start gap-3.5", className)}>
      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[#BF6D58]/15 bg-gradient-to-br from-[#BF6D58]/12 to-[#BF6D58]/5 text-[#BF6D58]">
        {icon}
      </div>
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        "shadow-[0_8px_28px_rgba(191,109,88,0.35)] hover:shadow-[0_12px_40px_rgba(191,109,88,0.45)]",
