...
import { Sparkles, Users, Clock, Star, GraduationCap } from "lucide-react";
...
function RelatedCourseCard({ course }: { course: RelatedCourse }) {
  ...
  return (
    <motion.a
      ...
      className="group flex w-72 shrink-0 flex-col overflow-hidden rounded-2xl border border-border/50 bg-card shadow-sm shadow-black/[0.03] transition-all duration-300 hover:-translate-y-1 hover:border-[#BF6D58]/30 hover:shadow-lg hover:shadow-[#BF6D58]/10 lg:w-auto"
    >
      {/* Cover */}
