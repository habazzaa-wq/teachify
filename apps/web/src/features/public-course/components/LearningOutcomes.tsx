      ...
      >
        {outcomes.map((outcome, index) => (
          <motion.div
            ...
            className="group flex items-start gap-3 rounded-2xl border border-border/60 bg-card p-4 shadow-sm shadow-black/[0.02] transition-colors duration-200 hover:border-[rgb(var(--brand-primary-rgb)/0.25)] hover:bg-[rgb(var(--brand-primary-rgb)/0.03)]"
          >
