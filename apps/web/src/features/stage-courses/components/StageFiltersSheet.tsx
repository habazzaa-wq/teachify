...
import type { StageCourseFilters, StageSubject, StageTeacher } from "../types";
import { StageFiltersPanel } from "./StageFiltersPanel";

interface StageFiltersSheetProps {
  open: boolean;
...
export function StageFiltersSheet({
  open,
  onOpenChange,
  searchDraft,
  onSearchDraftChange,
