  ...
  const card = (
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col gap-3 px-5 pb-5 pt-4 sm:px-6 sm:pb-6">
        ...
        {/* title */}
        <h3
          className="line-clamp-2 text-base font-bold leading-snug transition-colors duration-300 group-hover:text-[var(--stage-course-hover)] sm:text-lg"
          style={{
            color: isDark ? "#F0ECE6" : "#1a1510",
            ["--stage-course-hover" as string]: PRIMARY,
          }}
        >
          {course.title}
        </h3>
