...
const PUBLIC_ENDPOINTS = ["/tenant/by-domain", "/auth/login", "sanctum/csrf-cookie", "/auth/refresh", "/health", "/tenant/auth/login", "/tenant/auth/refresh", "/tenant/auth/forgot-password", "/tenant/auth/reset-password"];
