...
const PUBLIC_ENDPOINTS = ["/tenant/by-domain", "/public/news", "/public/hero", "/public/educational-stages", "/public/courses", "/public/why-choose-us", "/auth/login", "sanctum/csrf-cookie", "/auth/refresh", "/health", "/tenant/auth/login", "/tenant/auth/refresh", "/tenant/auth/forgot-password", "/tenant/auth/reset-password"];
