...
use App\Http\Controllers\Api\v1\ExamBank\ExamAnswerPageManageController;
use App\Http\Controllers\Api\v1\ExamBank\ExamAnswerPageReadController;
use App\Http\Controllers\Api\v1\ExamBank\ExamAnswerPageUploadController;
use App\Http\Controllers\Api\v1\ExamBank\ExamController;
use App\Http\Controllers\Api\v1\ExamBank\ExamEntryController;
use App\Http\Controllers\Api\v1\ExamBank\ExamManualGradingController;
use App\Http\Controllers\Api\v1\ExamBank\ExamResultController;
use App\Http\Controllers\Api\v1\ExamBank\ExamSessionController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'tenant.membership'])->group(function () {
        ...
        Route::post('/exam-sessions/{attempt}/answers/{examQuestion}/upload-intent', [ExamAnswerPageUploadController::class, 'uploadIntent'])->middleware('throttle:20,1');
        Route::post('/exam-sessions/{attempt}/answers/{examQuestion}/pages/{session}/confirm', [ExamAnswerPageUploadController::class, 'confirm'])->middleware('throttle:300,1');
        Route::put('/exam-sessions/{attempt}/progress', [ExamSessionController::class, 'saveProgress'])->middleware('throttle:300,1');
        Route::post('/exam-sessions/{attempt}/submit', [ExamSessionController::class, 'submit'])->middleware('throttle:10,1');
        Route::get('/exam-attempts/{attempt}/result', [ExamResultController::class, 'show']);
        Route::get('/exam-attempts/{attempt}/answers/{examQuestion}/pages', [ExamAnswerPageReadController::class, 'index'])->name('exam-bank.answer-pages.index');
        Route::get('/exam-attempts/{attempt}/answers/{examQuestion}/pages/{page}', [ExamAnswerPageReadController::class, 'show'])->name('exam-bank.answer-pages.show');
        Route::put('/exam-attempts/{attempt}/answers/{examQuestion}/pages/reorder', [ExamAnswerPageManageController::class, 'reorder'])->middleware('throttle:60,1');
        Route::delete('/exam-attempts/{attempt}/answers/{examQuestion}/pages/{page}', [ExamAnswerPageManageController::class, 'destroy'])->middleware('throttle:60,1');
        Route::put('/exam-attempts/{attempt}/answers/{answer}/grade', [ExamManualGradingController::class, 'grade'])->middleware('throttle:60,1');
        Route::get('/exams/{exam}/grading-queue', [ExamManualGradingController::class, 'pendingQueue']);
        Route::get('/exams/{exam}/attempts', [ExamResultController::class, 'history']);
        Route::post('/exam-attempts/{attempt}/practice', [ExamResultController::class, 'practice'])->middleware('throttle:10,1');
