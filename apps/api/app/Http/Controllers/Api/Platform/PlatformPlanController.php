...
class PlatformPlanController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'slug' => ['sometimes', 'string', 'max:255', 'unique:platform_plans,slug'],
        ...
        $plan = PlatformPlan::create([
            ...
            'monthly_price' => $validated['monthlyPrice'] ?? 0,
            'yearly_price' => $validated['yearlyPrice'] ?? 0,
            'currency' => $validated['currency'] ?? 'SAR',
            'display_order' => $validated['displayOrder'] ?? 0,
            'trial_enabled' => $validated['trialEnabled'] ?? false,
